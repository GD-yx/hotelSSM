...
<body>
<form action="/commodity/update" method="post">
    商品编号：<input type="text" name="cid" value="${commodity.cid}"/><br/>
    商品名称：<input type="text" name="cname" value="${commodity.cname}"/><br/>
    商品类型：
    <select name="coid">
    ...
    商品价格：<input type="text" name="cprice" value="${commodity.cprice}"/><br/>
